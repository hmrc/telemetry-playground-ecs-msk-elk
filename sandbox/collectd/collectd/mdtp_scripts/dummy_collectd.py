# Shamelessly stolen from https://github.com/signalfx/collectd-spark/blob/master/dummy_collectd.py
...
class DummyCollectd(object):
    ...
    def register_config(self, callback):
        print('register_config %s' % self.is_running_tests)
        assert self.is_running_tests
    ...
    def register_write(self, callback):
        assert self.is_running_tests
        self.registered_writes.append(callback)
...
# pylint: disable=invalid-name
register_write = INSTANCE.register_write
